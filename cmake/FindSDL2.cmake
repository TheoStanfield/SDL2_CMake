...
if(WIN32)
    find_path(SDL2_ROOT "include/SDL2/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../includes/SDL2" NO_DEFAULT_PATH)
    if(SDL2_ROOT)
        if (EXISTS "${SDL2_ROOT}/lib/libSDL2.a")
            set(SDL2_INCLUDE_DIRS "${SDL2_ROOT}/include")

            set(SDL_LIBS "")
            if(_SDL2_use_main)
                list(APPEND SDL2_LIBS "${SDL2_ROOT}/lib/libSDL2main.a")
            endif()
            list(APPEND SDL2_LIBS "${SDL2_ROOT}/lib/libSDL2.dll.a")

            set(SDL2_DLLS "${SDL2_ROOT}/bin/SDL2.dll")
        endif()
    endif()
